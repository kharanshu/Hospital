...
public class Addpharmacy extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, 150, -1));
        ...
        jPanel1.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 290, -1, -1));
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 200, 150, -1));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(!str.isEmpty()){
            try{ 
                    ...
                    append("Phone_No", jTextField4.getText()).
                    append("Medicine", jTextField3.getText());
                            coll.insert(doc);
                            
                    
                    JOptionPane.showMessageDialog(this, "Added Successfully!!");
                    Addpharmacy p=new Addpharmacy();
                    p.setVisible(true);
                    dispose();
                }
            catch(Exception e){
